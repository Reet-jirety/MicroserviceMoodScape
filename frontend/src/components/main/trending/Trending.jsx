    ...
    <div className="trending mt-[40px] flex items-center justify-between text-primary max-xs:hidden">
      <div className="left">
        ...
        <div className="info mt-[12px] p-[26px]">
          <h2 className='text-[56px] mb-[8px] max-4xl:text-[36px] max-3xl:text-[24px] font-bold text-white'>Lost Emotions</h2>
          <h4 className='inline text-white font-bold'>Rion Clarke</h4>
